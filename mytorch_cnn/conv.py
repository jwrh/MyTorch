...
class Conv1d_stride1():
    ...
    def backward(self, dLdZ):
        ...
        self.dLdW = np.transpose(self.dLdW,axes = [0,1,2])# TODO  
        print("desired",self.W.shape,self.dLdW.shape)
        print(dLdZ.shape) 



        # pre = np.transpose(dLdZ, axes = [1,0,2])
        self.dLdb = np.sum(dLdZ,axis =(0,2)) # TODO
        print("dess",(self.in_channels,1),self.dLdb.shape)
        # a = np.array(self.in_channels*[dLdZ])   
        # print(a.shape,self.in_channels)  
        ...
        k =np.flip(self.W,axis = 2)#how to concolve by channels? how to not convolve by 
...
class Conv2d_stride1():
    ...
    def backward(self, dLdZ):
        ...
        k = np.zeros(self.W.shape)
        k =np.flip(self.W,axis = (2,3))#how to concolve by channels? how to not convolve by 
...
class ConvTranspose1d():
    ...
    def forward(self, A):
        ...
        #TODO
        # upsample
        Q = self.upsample1d.forward(A) #TODO

        # Call Conv1d_stride1()
        Z = self.conv1d_stride1.forward(Q)  #TODO
